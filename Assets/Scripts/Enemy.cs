...
public class Enemy : MonoBehaviour
{
    ...
    public float chaseRange; // alcance da persegui��o
    ...
    private void MoveEnemy()
    {
        ...
        {
            // Se estiver dentro do alcance, move em dire��o ao player; se n�o, anda para a esquerda
    ...
    private void ChasePlayer(float distanceToPlayer)
    {
        ...
        {
            // Move em dire��o ao player.
            // Use MoveTowards para movimento est�vel sem varia��es de f�sica.
        ...
        {
            // Opcional: quando estiver muito perto voc� pode atacar, ficar parado, etc.
            // Por enquanto, fica parado (ou voc� pode aplicar uma l�gica de dano por contato).
        }
    }
